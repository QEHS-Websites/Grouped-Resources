...
Easy way to get pathway for image or other file ... at school when student on server
- drag file (image) to browser's search bar
- copy image link
- paste this into href, any image should work but it will only run locally
